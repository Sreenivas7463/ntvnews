...
newsRouter.get('', async(req, res) => {
   try {
        const newsAPI = await axios.get(`https://ntvtelugu.com/wp-json/wp/v2/posts?per_page=100&page=1`)
...
newsRouter.get('/page/:p', async(req, res) => {
    ...
    try {
        const newsAPI = await axios.get(`https://ntvtelugu.com/wp-json/wp/v2/posts?per_page=100&page=${pageNo}`)
...
newsRouter.post('', async(req, res) => {
    ...
    try {
        const newsAPI = await axios.get(`https://ntvtelugu.com/wp-json/wp/v2/posts?search=${search}`)
